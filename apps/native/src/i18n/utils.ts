...
import { getPreferences, updatePreferences } from "@/state/persisted/preferences-store";
import { getLocales } from "expo-localization";
import { I18nManager } from "react-native";

const SUPPORTED_LANGUAGE_CODES = new Set<string>(LANGUAGES.map((language) => language.code));
